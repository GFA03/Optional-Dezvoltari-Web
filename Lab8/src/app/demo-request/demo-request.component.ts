...
export class DemoRequestComponent implements OnInit {
  ...
  ngOnInit(): void {
    let userId = 2;
    this.httpClient
      .get<Student>(`${this.apiUrl}/students/byId/${userId}`)
    ...
    let params = { id: 3 };
    this.httpClient
      .get<Student>(`${this.apiUrl}/students/fromQuery/`, { params })
      .subscribe((data: Student) => {
        console.log(data);
    ...
    this.httpClient
      .get<Student>(`${this.apiUrl}/students/fromHeader`, { headers })
      .subscribe((data: Student) => {
        console.log(data);
    ...
    this.httpClient
      .post(`${this.apiUrl}/students/fromForm`, formData)
      .subscribe((data) => {
        console.log(data);
      });
    ...
    this.httpClient
      .post(`${this.apiUrl}/students/fromBody`, newStudent)
      .subscribe((data) => {
        console.log(data);
      });
    ...
    let userId2 = 2;
    this.httpClient
      .patch(`${this.apiUrl}/students/${userId2}`, patchObject)
      .subscribe((data) => {
        console.log(data);
      });
  }
